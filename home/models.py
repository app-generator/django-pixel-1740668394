...
class UserProfile(models.Model):
    ...
    cost center = models.CharField(max_length=255, null=True, blank=True)
...
class Project(models.Model):
    ...
    tech id = models.CharField(max_length=255, null=True, blank=True)
    id = models.CharField(max_length=255, null=True, blank=True)
    internal id = models.CharField(max_length=255, null=True, blank=True)
